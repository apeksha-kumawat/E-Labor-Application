        ...
        try {
            ...
            if (obj.verify(data).equals("User Exist")) {
                ...
                if (data.length() == 10 && isNumeric(data)) {// for SMS
                    ...
                    try {
                        URL url = new URL(
                                "https://www.smsgatewayhub.com/api/mt/SendSMS?APIKey=mEqohcn9GEaBp2334IwuVg&senderi" +
                                        "d=TESTIN&channel=2&DCS=0&flashsms=0&number=" + data
                                        + "&text=Your%20OTP%20is%20" + Integer.toString(generatedOTP)
                                        + ".%20E-Labour%20Delhi&route=13");
